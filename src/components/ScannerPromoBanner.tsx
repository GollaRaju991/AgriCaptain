...
const ScannerPromoBanner = () => {
  ...
  return (
    <div className="w-full px-2 md:px-4 py-3">
      <Link to="/scanner">
        <div className="relative bg-gradient-to-br from-green-50 via-emerald-50 to-green-100 rounded-2xl overflow-hidden shadow-sm border border-green-100 flex items-stretch min-h-[160px] md:min-h-[200px]">
          {/* Left Content */}
