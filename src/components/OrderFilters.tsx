      ...
      {hasActiveFilters && (
        <div className="flex flex-wrap items-center gap-2 mb-4">
          {statusFilters.map(s => {
            ...
            return (
              <span key={s} className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-green-100 text-green-800 text-xs font-medium border border-green-200 cursor-default">
                {label}
          ...
          {timeFilter && (
            <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-green-100 text-green-800 text-xs font-medium border border-green-200 cursor-default">
          ...
          <button onClick={onClearFilters} className="inline-flex items-center px-2.5 py-1 rounded-full bg-red-100 text-red-700 text-xs font-medium border border-red-200 hover:bg-red-200 transition-colors">
            Clear All
          </button>
        </div>
      )}
