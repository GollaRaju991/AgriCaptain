            ...
            <div className="lg:hidden" style={{ background: 'linear-gradient(135deg, #1FAF5A 0%, #0E8A43 100%)' }}>
              ...
              >
                ...
                <div className="flex items-center gap-2 ml-auto">
                  <Link
                    to="/become-seller"
                    className="flex items-center gap-0.5 bg-white/90 backdrop-blur-sm rounded-md px-1.5 py-0.5 shadow-sm"
                  >
                    <UserPlus className="h-3 w-3 text-green-700" />
                    <span className="text-[9px] font-semibold text-green-800 whitespace-nowrap">Start Selling</span>
                  </Link>
                  ...
                  >
                    ...
                    <span className="text-[9px] font-semibold text-green-800 whitespace-nowrap">{translations.language}</span>
                  </button>
