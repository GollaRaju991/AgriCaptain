...
const ProfileInformation: React.FC<Props> = ({ profile, userEmail, userId }) => {
  ...
  useEffect(() => { if (!isMobile && userId) fetchAddresses(); }, [userId, isMobile]);
    ...
    <div className="bg-card border rounded-xl p-8 space-y-10 shadow-sm">
      ...
      {!isMobile && (
        <div>
          ...
          {showAddressForm && (
            <div className="border-2 border-primary rounded-lg p-6 mb-5 bg-primary/5">
