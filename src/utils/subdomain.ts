 ...
 * - yourdomain.com        → customer app only (admin routes return 404)
 *
...
export const isAdminSubdomain = (): boolean => {
  ...
  // Dev / preview hosts → treat as main app (use /admin/login path instead)
  ...
  // Production: only admin.* subdomain triggers admin mode
